-- Migration to change attendance_list.empid from INTEGER to VARCHAR(20)
-- This allows it to reference users.empid (string) instead of users.id (integer)
